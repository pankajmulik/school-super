      ...
      <Carousel activeIndex={index} direction={direction} onSelect={handleSelect} fade={fade} style={{ width: '100%', height: '500px' }}>
        ...
        <Carousel.Item>
          <div style={{ position: 'relative' }}>
            <img className='d-block w-100' src={img1} alt='img1' style={{ maxHeight: '500px', objectFit: 'cover' }} />
        ...
        <Carousel.Item>
          <div style={{ position: 'relative' }}>
            <img className='d-block w-100' src={img2} alt='img2' style={{ maxHeight: '500px', objectFit: 'cover' }} />
        ...
        <Carousel.Item>
          <div  style={{ position: 'relative'  }}>
            <img className='d-block w-100' src={img3} alt='img3' style={{ maxHeight: '500px', objectFit: 'cover',  }} />
